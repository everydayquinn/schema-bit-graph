...
| JVM (parser_jvm via javap) | **shipped Day 3** | stack-machine vocab; static analysis complement to register-machine travelers | low (javap + small parser) | 200 facts from CountUp.class (3 methods, 26 insns); 9 hand-computed correctness tests verify mechanism; calibration anchor for larger JVM targets |
